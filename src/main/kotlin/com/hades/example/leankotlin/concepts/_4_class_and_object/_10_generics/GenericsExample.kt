package com.hades.example.leankotlin.concepts._4_class_and_object._10_generics
...
fun main() {
    ...
    run {
        ...
        class FoodStore : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<Food> {
        ...
        class FastFoodStore : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<FastFood> {
        ...
        class InOutBurger : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<Burger> {
        ...
        val production: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<Food> = FoodStore()
        production.produce()    // FoodStore produce food
        val production2: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<Food> = FastFoodStore()
        production2.produce()   // FastFoodStore produce FastFood
        val production3: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Production<Food> = InOutBurger()
         ...
         */
        class EveryBody : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Food> {
            override fun consume(item: Food) {
                println("EveryBody eat food")
            }
        }

        class ModernPeople : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<FastFood> {
            override fun consume(item: FastFood) {
                println("ModernPeople eat FastFood")
            }
        }

        class American : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Burger> {
        ...
        // 美国的汉堡的消费者既是现代人，更是人类。
        val consumer1: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Burger> = EveryBody()
        consumer1.consume(Burger()) // EveryBody eat food
        val consumer2: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Burger> = ModernPeople()
        consumer2.consume(Burger())     // ModernPeople eat FastFood
        val consumer3: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Burger> = American()
        consumer3.consume(Burger())     // American eat Burger

        val consumer1_1: com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Consumer<Food> = EveryBody()
...
//        val stringValue = intValue.basicToString()    // 从上下文可有推断出来的类型参数，可以省略
    ...
    run {
        ...
        run {
            class JBoxImpl : com.hades.example.leankotlin._4_class_and_object._10_generics.JBox {
    ...
    run {
        ...
        class SomeImplementation : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.SomeClass<String>() {
            override fun execute(): String {
                return "test"
            }
        }

        class OtherImplementation : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.SomeClass<Int>() {
        ...
        val s = com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Runner.run<SomeImplementation, _>()
        println(s)

        // T is inferred as Int
        val n = com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.Runner.run<OtherImplementation, _>()
        println(n)
    }
}
...
internal object Runner {
    inline fun <reified S : com.hades.example.leankotlin.concepts._4_class_and_object._10_generics.SomeClass<T>, T> run(): T {
